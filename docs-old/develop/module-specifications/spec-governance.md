...
Check the [Governance section of the `terrad` Reference](../terrad/subcommands.mdx#tx-gov-submit-proposal) to see examples of how to participate in the Governance process.
