...
For more information on terrad, see [`terrad` guides](../develop/terrad/README.mdx).
...
A version of the mainnet just for testing. The testnet does not use real coins. You can use the testnet to get familiar with transactions. The current testnet for Terra is [`pisco-1`](../../docs/develop/endpoints.mdx)
